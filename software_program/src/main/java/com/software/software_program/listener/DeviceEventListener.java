...
//        if (event.getEntity() instanceof EquipmentSoftwareEntity classroomSoftware) {
...
//        } else if (event.getEntity() instanceof EquipmentSoftwareEntity classroomSoftware) {
...
//        if (entity instanceof EquipmentSoftwareEntity classroomSoftware) {
